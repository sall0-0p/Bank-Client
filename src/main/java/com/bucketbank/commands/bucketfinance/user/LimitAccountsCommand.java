...
public class LimitAccountsCommand implements Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        try {
            if (!sender.hasPermission("bucketfinance.user.limit")) {
            ...
            user.setAccountLimit(Integer.parseInt(args[1]));
            ...
            // Print message
            String initialMessage = Messages.getString("user.limit_changed");
